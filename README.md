...
The [Mask-RCNN-TF2_MM](https://github.com/mmcfer/Mask-RCNN-TF2_MM) project edits the original [Mask-RCNN-TF2](https://github.com/ahmedfgad/Mask-RCNN-TF2) project on TensorFlow 2.0. The Mask R-CNN model generates bounding boxes and segmentation masks for each instance of an object in the image. It's based on Feature Pyramid Network (FPN) and a ResNet101 backbone.
